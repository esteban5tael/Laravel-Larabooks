        ...
        <div class="px-2 md:px-20 pt-6 max-w-7xl mx-auto">
            ...
            <div class="flex flex-col-reverse md:flex-row items-center mt-20 lg:mt-32 gap-8">
                ...
                <img src="https://res.cloudinary.com/dy09hqrno/image/upload/v1691588230/hero_wtour7.png"
                    alt="hero image" class="md:w-1/2 rounded-xl mb-10 shadow-md">
            </div>
                    ...
                    <div class="bg-white p-4 rounded-xl flex gap-6 items-center shadow-xs">
                        <div class="w-1/4 flex flex-col items-center">
                            <img src="https://m.media-amazon.com/images/I/41SH-SvWPxL._SX342_SY445_QL70_ML2_.jpg"
                                alt="image book clean code" class="w-4/5">
                    ...
                    <div class="bg-white p-4 rounded-xl flex gap-6 items-center  shadow-xs">
                        <div class="w-1/4 flex flex-col items-center">
                            <img src="https://images.cdn2.buscalibre.com/fit-in/360x360/03/1a/031af9d7e401bb2d08911c317ecbedad.jpg"
                                alt="image book pragmatic programmer" class="w-4/5">
                    ...
                    <div class="bg-white p-4 rounded-xl flex gap-6 items-center  shadow-xs">
                        <div class="w-1/4 flex flex-col items-center">
                            <img src="https://m.media-amazon.com/images/I/7169VZEOYFL._AC_UF1000,1000_QL80_.jpg"
                                alt="image book design pattern" class="w-4/5">
                        ...
                        <div class="flex flex-col gap-2 w-3/4">
                            ...
                            <p class="text-base text-gray-500">Este libro es un tesoro de conocimiento sobre patrones
                                de
                    ...
                    <div class="bg-white p-4 rounded-xl flex gap-6 items-center  shadow-xs">
                        <div class="w-1/4 flex flex-col items-center">
                            <img src="https://images-na.ssl-images-amazon.com/images/I/51FrXXE3j7L._AC_UL210_SR210,210_.jpg"
                                alt="image book clean code" class="w-4/5">
                            <p class="text-gray-600 text-sm text-center mt-2">Introduction to the Theory of Computation
                            </p>
                        </div>
                        <div class="flex flex-col gap-2 w-3/4">
                            <div class="flex items-center">
                            ...
                            <p class="text-base text-gray-500">Este libro ofrece una introducción completa y accesible
                                a la
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <a href="#"
                        ...
                        <div>
                            <div class="p-4">
                                <div>
                                    <h2 tabindex="0" class="focus:outline-none text-lg font-semibold">Clean Code
                                    </h2>
                                    <p class="text-sm text-gray-500">por Robert C. Martin</p>
                                </div>
                                <div class="flex mt-4">
                    ...
                    <a href="#"
                        ...
                        <div>
                            <div class="p-4">
                                <div>
                                    <h2 tabindex="0" class="focus:outline-none text-lg font-semibold">The C
                                        Programming
                                        Language</h2>
                                ...
                                <div class="flex mt-4">
                                    ...
                                    <div class="pl-2">
                                        <p tabindex="0"
                                            class="focus:outline-none text-xs text-gray-600 px-2 bg-gray-200 py-1">C
                                        </p>
                                    </div>
                                </div>
                                <div class="flex items-center mt-4 gap-2">
                    ...
                    <a href="#"
                        ...
                        <div>
                            <img alt="person capturing an image"
                                src="https://m.media-amazon.com/images/I/71sL0Qpd+YL.jpg" tabindex="0"
                    ...
                    <a href="#"
                        ...
                        <div>
                            <div class="p-4">
                                <div>
                                    <h2 tabindex="0" class="focus:outline-none text-lg font-semibold">Clean
                                        Architecture: A
                    ...
                    <a href="#"
                        ...
                        <div>
                            <div class="p-4">
                                <div>
                                    <h2 tabindex="0" class="focus:outline-none text-lg font-semibold">Domain-Driven
                                        Design:
            ...
            <footer class="p-4 rounded-lg shadow md:px-6 md:py-8 bg-gray-800">
                ...
                <span class="block text-sm sm:text-center text-gray-400">© 2023 <a href="https://flowbite.com"
                        target="_blank" class="hover:underline">{{ config('app.name') }}™</a>. All Rights Reserved.
                </span>
            </footer>
            <!-- /Footer -->
