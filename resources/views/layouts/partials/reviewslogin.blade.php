<div
    ...
    <svg xmlns="http://www.w3.org/2000/svg" id="bb6a8e0f-9216-4739-b80e-a5efc2c838ab" data-name="Layer 1" class="h-56"
        ...
        <path
            ...
            fill="#ccc" />
        <path d="M373.13,152.69a24.66,24.66,0,1,1-35-22.4,18.42,18.42,0,1,1,19.43-.5A24.65,24.65,0,0,1,373.13,152.69Z"
            fill="#ccc" />
        ...
        <path d="M581.93,436.1v-29s-7.94,14.38-24.58,13.33L556,428.92S573.28,433,581.93,436.1Z" fill="#2f2e41" />
        <path
        ...
        <path
            ...
            fill="#2f2e41" />
        <path d="M546.3,642.21s-12.44-11.44-12.06-22.38l37.18,14.11S553.85,640.83,546.3,642.21Z" fill="#2f2e41" />
        <path
            ...
            fill="#0071f2" />
        <path d="M526.11,620.72s-7.33,23.93,10.77,21.49c0,0-4.61,6.32-21,5.89,0,0,.63-8.41-2.42-26Z" fill="#0071f2" />
        <path d="M637.18,620.72s-5.65,14.61-2.7,25.28c0,0-13.59,2.65-20.78-6.31l9.77-20.44Z" fill="#0071f2" />
        <path
            ...
            fill="#2f2e41" />
        <polygon points="567.29 490.84 579.27 459.22 610.35 461.06 588.82 517.74 559.33 517.74 567.29 490.84"
            fill="#2f2e41" />
        <path
        ...
        <path
            ...
            fill="#2f2e41" />
        <path d="M556.65,424.73l.7-4.34s-11.57-.91-18.48-13.33C538.87,407.06,539.18,420.16,556.65,424.73Z"
            fill="#f4a48e" />
    ...
    <div>
        <a href="{{ route('login') }}" class="underline">Inicia Sesión</a> o <a href="{{ route('register') }}"
