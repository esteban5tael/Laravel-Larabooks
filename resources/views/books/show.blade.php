                ...
                <div class="col-span-2 flex flex-col items-center">
                    <div class="bg-white w-full flex flex-col items-center rounded-xl p-6">
                        <img src="https://m.media-amazon.com/images/I/41SH-SvWPxL._SX342_SY445_QL70_ML2_.jpg"
                            alt="book clean code image" class="w-full h-[20rem] object-contain">
                        <a href="#reviews"
                ...
                <div class="col-span-4 bg-white p-6 rounded-xl">
                    <div>
                        ...
                        <div class="flex items-center mt-2">
                            ...
                            <span class="text-gray-500 text-sm">{{ $book->published_at }}</span>
                        </div>
                    ...
                    <div id="reviews">
                        ...
                        <div
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" id="bb6a8e0f-9216-4739-b80e-a5efc2c838ab"
                                ...
                                <path d="M621,642.21l-28.28-9.8,9.8-24.27,23.76,12.58S632.66,632.91,621,642.21Z"
                                    fill="#f9b499" />
                                <rect x="183.93" y="25.35" width="325.13" height="622.75" rx="25.71"
                                    fill="#2f2e41" />
                                <rect x="190.42" y="29.03" width="312.38" height="613.18" rx="23.73"
                                    fill="#ccc" />
                                <path
                                ...
                                <path
                                    ...
                                    fill="#ccc" />
                                <rect x="205.41" y="312.43" width="284.14" height="48.58" rx="11.57"
                                    fill="#bcbec0" />
                                <rect x="207.12" y="372.06" width="284.14" height="48.58" rx="11.57"
                                    fill="#bcbec0" />
                                <rect x="223.81" y="330.84" width="125.37" height="11.04" rx="5.52"
                                    fill="#fff" />
                                <rect x="364.18" y="331.2" width="74.58" height="11.04" rx="5.52"
                                    fill="#fff" />
                                ...
                                <rect x="285.64" y="446.53" width="124.29" height="41.96" rx="20.98"
                                    fill="#bcbec0" />
                                ...
                                <path
                                    ...
                                    fill="#2f2e41" />
                                <path
                                    d="M546.3,642.21s-12.44-11.44-12.06-22.38l37.18,14.11S553.85,640.83,546.3,642.21Z"
                                    fill="#2f2e41" />
                                <path
                                ...
                                <path
                                    ...
                                    fill="#2f2e41" />
                                <ellipse cx="536.66" cy="378.44" rx="8.83" ry="10.55"
                                    fill="#f9b499" />
                            </svg>
                            <div>
                                <a href="#" class="underline">Inicia Sesión</a> o <a href="#"
                                    class="underline">Regístrate</a> para que puedas
                                crear
                                una
                                reseña
                            </div>
                        ...
                        <div class="grid grid-cols-1 gap-4">
                            <!-- Review Item -->
                            <div>
                                <p class="text-base text-gray-900 font-medium">Excelente guía para mejorar la calidad
                                    del
                                    código</p>
                                <p class="text-base text-gray-500">Este libro me ha ayudado enormemente a escribir
                                    código
                                    más
                                    limpio
                                    y comprensible. Los ejemplos y
                                    principios presentados son muy claros y fáciles de seguir. Lo recomendaría a
                                    cualquier
                                    programador
                            ...
                            <!-- Review Item -->
                            <div>
                                <p class="text-base text-gray-900 font-medium">Imprescindible para cualquier
                                    programador</p>
                                <p class="text-base text-gray-500">Este libro es una joya. Ofrece consejos prácticos y
                                    perspectivas únicas sobre el arte de programar. Me ha ayudado a mejorar mis
                                    habilidades
                                    de
                                    resolución de problemas y a adoptar un enfoque más pragmático en mi trabajo. Es un
                                    libro
                                    que
                            ...
                            <!-- Review Item -->
                            <div>
                                <p class="text-base text-gray-900 font-medium">Guía esencial para el diseño de software
                                </p>
                                <p class="text-base text-gray-500">Este libro es un tesoro de conocimiento sobre
                                    patrones de
